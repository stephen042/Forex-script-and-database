           ...
           <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-user"></i> User Referral <a href="#register-acct"><button type="button" class="btn btn-round btn-primary"><i class="fa fa-plus"></i> Add Referral</button></a></h3>
              </div>
            ...
            <br><br>
            <?php 
          $query_st = mysqli_query($conn, "SELECT * FROM user_tb, referral_tb where user_tb.user_id = referral_tb.ref_uid ORDER BY referral_tb.ref_id DESC");
            ...
            ?>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <!--<th>Username</th>-->
                            <th class="column-title">User referral Email</th>
                      ...
                      <td ><a href="bonus-referral?id=<?php echo sha1($id); ?>"><button class="btn btn-round btn-xs btn-primary" type="button"><i class="fa fa-plus"></i></button></a>  
<a href="delete-referral?id=<?php echo sha1($id); ?>"><button class="btn btn-round btn-xs btn-danger" type="button"><i class="fa fa-times"></i></button></a></td>
                      </tr>
                      <?php 
                        }
                          }
