...
<html lang="en">
  <head>
    ...
    <title>Citizens Financial Bank | Credit Users Account</title>
  ...
  <body class="nav-md">
           ...
           <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-user"></i>  Account Transaction</h3>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><small>Note: You Can Run Crediting or Debiting User Account from Here.</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
                          $user_query = mysqli_query($conn, "select * from register_user");
    ...
    <tr>
        ...
        <td><?php echo $row['acct_pin']; ?></td> 
  
        <td><?php echo $row['fname']; ?> <?php echo $row['lname']; ?></td>
  
        <td><?php echo $row['acct_number']; ?></td>
        <td><?php echo $row['acct_type']; ?></td>
        <td><?php echo $row['currency_type'].@number_format(@$row['amount'], 2); ?></td>
  
        <td><a href="debit_user.php?id=<?php echo $id; ?>" class="btn btn-round btn-xs btn-primary " type="button"><i class="fa fa-edit"></i></a>
        </td>
      </tr>
      <?php } ?> 
