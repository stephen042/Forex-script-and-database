...
<html lang="en">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                 <li><a href="index"><i class="fa fa-home"></i> Home</a>
                  ...
                  <li class="active"><a href="pending-account"><i class="fa fa-book"></i> Pending Account</a>
           ...
           <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-user"></i> Pending Account <a href="register-acct"><button type="button" class="btn btn-round btn-primary"><i class="fa fa-plus"></i> Register New Account</button></a></h3>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><small>Note: All user account details that are pending.</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
      $query = mysqli_query($conn,"select * from register_user where acct_status ='Pending' ORDER BY reg_id DESC");
  while ($row = mysqli_fetch_array($query)) {
    ...
    <tr>
        ...
        <td><a href="activate-account?id=<?php echo $id; ?>" class="btn btn-round btn-xs btn-primary " type="button"><i class="fa fa-check"></i> Activate</a>
        <a href="delete-pending-account?id=<?php echo $id; ?>" class="btn btn-round btn-xs btn-danger " type="button"><i class="fa fa-check"></i> Delete</a> </td>
      </tr>
      <?php } ?> 
