...
<html lang="en">
  <head>
    ...
    <title>Admin | Users System Log Details</title>
    ...
    <div class="container body">
      <div class="main_container">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                 <li><a href="index"><i class="fa fa-home"></i> Home</a>
                  ...
                  <li class=""><a href="users-log"><i class="fa fa-magnet"></i> Logs</a>
                  </li>
                  <li class="active"><a href="system-log"><i class="fa fa-magnet"></i> System Activities</a>
                  </li>
              </div>
        ...
        <div class="right_col" role="main">
           ...
           <?php 
            $query = mysqli_query($conn, "SELECT * FROM activities_log");
                        ...
                        <thead>
                          <tr class="headings">
                           ...
                           <th class="column-title">#</th>
                            ...
                            <th class="column-title">Activities Perform</th>
                            <th class="column-title">Record Date</th>
                            </tr>
                        </thead>
                        <tbody>
                          <?php
                  $query_st = mysqli_query($conn," SELECT * FROM activities_log");
                  $counter = 0;
                  while(@$row = mysqli_fetch_array($query_st)){
                    ...
                    $counter++;
                      ...
                      ?>
                        ...
                        <td><?php echo @$row['act_username']; ?></td>
                        <td><?php echo @$row['act_action']; ?></td>
                        ...
                        {
                    echo'<div class="text-center p2"><p>No current system log at the moment</p></div>
                </div>';
                        }
                        '<br>';
                      ?>    
