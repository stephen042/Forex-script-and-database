...
<html lang="en">
  <head>
    ...
    <title>Citizens Financial Bank | User Log Details</title>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li class=""><a href="user-transaction"><i class="fa fa-file"></i> Transaction</a>
                  ...
                  <li class="active"><a href="user-log"><i class="fa fa-magnet"></i> User Log</a>
                  </li>
           ...
           <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-user"></i>  User Log </h3>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <tbody>
                          <?php
                          $user_query = mysqli_query($conn,"select * from user_log order by user_log_id ");
                          while($row = mysqli_fetch_array($user_query)){
                          $id = $row['user_log_id'];
                          if($row['online_status'] == '1'){
                                    $mystatus = '<span class="label label-info"> Online </span>';
                                    }else
                                    if($row['online_status'] == 0){
                                    $mystatus = '<span class="label label-danger"> Log-out </span>';
                                    }
                          ?>
                  
                        <tr>
                      
                        <td><?php echo $row['user_log_username']; ?></td>
                        <td><?php echo $row['log_name']; ?></td>
                        <td><?php echo $mystatus; ?></td>
                        <td><?php echo $row['log_ip']; ?></td>
                        <td><?php echo $row['log_country']; ?></td>
                        <td><?php echo $row['log_broswer']; ?></td>
                        <td><?php echo $row['log_date']; ?></td>
                        <td><?php echo $row['logout_date']; ?></td>
                        <td><?php echo $row['log_user_activity']; ?></td>
