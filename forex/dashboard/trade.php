<?php
							...
							$query_update = mysqli_query($conn, "UPDATE user_tb SET u_amount ='$current_bal' WHERE user_id = '$session_id'");
														...
														echo "<font color='#009966'> Trading successfully placed</font>";
														echo header("location: index.php");  // wrong details
																				
														}
												}
														else{
														echo die("<font color='#FF6600'> Error occured! try again.</font>") ;  // wrong details 
															}
