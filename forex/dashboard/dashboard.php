            ...
            <div class="wallet-drop-func" data-ng-func="" style="position:absolute; top: 40px; right: 0px; width:250px;">
                <div class="ui dropdown amount-dropdown walletdrop" tabindex="0" style="width:250px; z-index:99;">
                    ...
                    <div class="text"><div class="amount-item">
								...
								<span style="margin-top:10px;"><b><?php echo $acct_amt2.'.00'?></b> <b>EUR</b></span>
...
<div class="tradingview-widget-container" >
  ...
  "container_id": "tradingview_eeb1c"
		...
		<form action="trade.php" method="post" style="overflow: visible;" onsubmit="return call()" name="tradeform" id="tradeform" >
			...
			<time style="float: right; color:#FF0000" id="time"></time></label>
			<div>
			<!--
			<input type="hidden" value="">
			<i class="dropdown icon" tabindex="0">
			<div class="menu" tabindex="-1"></div></i>
			<div class="default text">1min</div>
			<div class="menu" tabindex="-1">
			...
			<div class="item" onclick="expTime('28')">28min</div><div class="item" onclick="expTime('29')">29min</div><div class="item" onclick="expTime('30')">30min</div>
			
			</div>
			-->
		    <select class="category ui option-select selection dropdown" tabindex="0" name="time" id="time" required>
			<option></option>
   
			<option value="01">1min</option>
			<option value="02">2min</option>
			<option value="03">3min</option>
			
			<option value="04">4min</option>
			<option value="05">5min</option>
			<option value="06">6min</option>
			<option value="07">7min</option>
			<option value="08">8min</option>
			<option value="09">9min</option>
			...
			<input type="text" id="amount" name="trade_amt" class="input-number amount-input" required>
			<div class="input-number-more"></div>
			<div class="input-number-less"></div></div>
			
			<div class="line"></div>
			
			<!--<label><font color="#FC0"><b> Acc Type: <span title="Trade account type for trading." class="ask">?</span></b></font></label>
			<div class="input-number-box">
			<select class="category ui option-select selection dropdown" tabindex="0" name="acct_type" id="acct_type" required>
			<option></option>
   
			<option value="Live Wallet"> <?php //echo 'Use Demo Account '.$demo_amt2.'.00';?></option>
			<option value="Demo Wallet"><?php //echo 'Use Live Account '.$demo_amt2.'.00';?></option>
			</select>
			<div class="input-number-more"></div>
			<div class="input-number-less"></div></div>
			-->
			...
			<div class="profit-sum"><b><font color="#0D884E" size="+2"><span id="profit" value=""></span></font></b> <span class="profit-cur">EUR</span><?php echo $newm;?>
			...
			<button class="ui button primal green" style="height:50px; width:170px; margin-bottom:10px" onclick="call()" id="btn_trade" name="btn_trade">Call</button>
			 <label><!-- react-text: 125 --><a><font color="#fff">Cap Rate:</font></a> <!-- /react-text --><span title="Trading current cap rate." class="ask"></span></label></a>
			<input type="text" value="87% +0.87" style="margin-bottom:10px; width:200px;" readonly="" id="percent" />
			<div id="error"></div>
			<button class="ui button primal red" style="height:50px; width:170px; margin:0 auto;" onclick="call()" id="btn_trade" name="btn_trade">Put</button>
			</div>
			<br><br>
			<br><br>
			</div>
