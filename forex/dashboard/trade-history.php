														...
														<meta charset="utf-8">
															...
															<title> Providus Option History    </title>
...
<div style="">
												<section class="content-box history-min">
													...
													<table class="" style=" min-width:600px;">
														...
														<?php
									$query_st = mysqli_query($conn," SELECT * FROM trading_tb WHERE td_uid = '$session_id'");
									$counter = 0;
